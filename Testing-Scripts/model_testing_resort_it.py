...
RESULTS_FILE = "resort_it_waste_classification_results.txt"

trashnet = load_dataset("garythung/trashnet", split="train")
image_folder_path = "ReSort-IT/basic/train"

all_image_files = os.listdir(image_folder_path)
file_set = all_image_files[0:3540]
...
for image_file in file_set:
    ...
    image_data = { "image_info": image_file, "actual_class_id": image_file[0] }
